...
namespace remcoov\youtubechannelfeed\widgets;

use remcoov\youtubechannelfeed\YoutubeChannelFeed;
use remcoov\youtubechannelfeed\assetbundles\youtubechannelfeedwidgetwidget\YoutubeChannelFeedWidgetWidgetAsset;

use Craft;
use craft\base\Widget;

/**
 * Youtube Channel Feed Widget
 *
 ...
 * @since     1.0.0
 */
class YoutubeChannelFeedWidget extends Widget
{
    ...
    {
        return Craft::t('youtube-channel-feed', 'Youtube Channel Feed');
    }
    ...
    {
        return Craft::getAlias("@remcoov/youtubechannelfeed/assetbundles/youtubechannelfeedwidgetwidget/dist/img/YoutubeChannelFeedWidget-icon.svg");
    }
    ...
    public function rules()
    {
        ...
        $rules = array_merge(
            ...
            [
                ...
                [['limit'], 'required', 'message' => 'Please enter a limit.'],
                [['channel_id'], 'required', 'message' => 'Please enter a Youtube Channel ID.'],
                [['channel_id'], 'string', 'length' => [24,24]]
            ]
        );
        return $rules;
    }
    ...
    public function getBodyHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            ...
            [
                ...
                'channelTitle' => $widgetFeed['channelTitle'],
                'channelUrl' => $widgetFeed['channelUrl'],
                'youtube_feed' => $widgetFeed['youtube_feed'],
                'limit' => $limit
            ]
        );
